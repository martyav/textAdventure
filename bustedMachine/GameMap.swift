...
let secondBasement = Node(location: "Second Basement", description: "You find yourself inside a shotgun shack. Down another set of creaky stairs is the second basement. It is as big as the house is long. The floor is spread with shag carpeting. Colorful GRAFFITI and stickers cover the beige TILES.\n\nYou see three Monsters sitting around a record player: COOKIEPUSS, POSSUM, and FUTURE." , objects: [Tiles.name: Tiles, Graffiti.name: Graffiti], npcs: [Cookiepuss.name: Cookiepuss, Possum.name: Possum, FutureCreep.name: FutureCreep])
