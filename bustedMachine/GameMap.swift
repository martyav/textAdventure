...
let laundryRoom = Node(location: "Laundry Room", description: "You find yourself inside a shotgun shack. This is a smelly, humid room made up of bare beige TILES. Pipes and wires connect to a pair of large white MACHINES. Next to the MACHINES are some plastic bottles and cardboard boxes.", objects: [Tiles.name: Tiles, Poster.name: Poster])
