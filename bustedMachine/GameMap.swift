...
let kitchen = Node(location: "Kitchen", description: "You find yourself inside a shotgun shack. This kitchen is vividly painted green and orange. Someone has spraypainted 'Humans suck!' on the wall. There is a round formica TABLE, a REFRIGERATOR, and many open CABINETS. There is a big HOLE in the floor by the SINK.", objects: [Sink.name: Sink, Refrigerator.name: Refrigerator, Cabinets.name: Cabinets, Hole.name: Hole])
