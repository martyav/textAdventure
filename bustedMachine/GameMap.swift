...
let nearHighway = Node(location: "Near Highway", description: "You are standing on the shoulder of an enormous highway. It's very empty and very quiet. Occassionally, huge trucks flash by in twinkling single-file columns.")
...
let shotgunShack = Node(location: "Shotgun Shack", description: "You find yourself standing in front of a shotgun shack. It looks very weathered. Someone has spraypainted the words 'Monster Party' and a crude drawing of a googly-eyed monster across the porch.")
...
let secondBasement = Node(location: "Second Basement", description: "You find yourself inside a shotgun shack. Down another set of creaky stairs is the second basement. It is as big as the house is long. The floor is spread with shag carpeting. Colorful graffiti murals and stickers cover the beige tile walls.")
