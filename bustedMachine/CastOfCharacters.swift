...
let AnonymousActor3 = NonPlayer(name: "Chilterverk Kreestrong", pronouns: PronounSet.he, kind: .Tresson)
...
func randomlyPickActor() -> NonPlayer {
    ...
    AnonymousActor3.appearance = "\(AnonymousActor3.name) is a famous Tresson entertainer. \(AnonymousActor3.pronouns[2].capitalized) main claim to fame is that \(AnonymousActor3.pronouns[0]) is hugely muscular. Most Tresson are narrow and kind of weedy-looking, but \(AnonymousActor3.name) is built like a brick house. There is a small yet vocal subculture of Human and Hatchasee fans who find \(AnonymousActor3.pronouns[1]) very, VERY attractive. \(AnonymousActor3.name) is, ironically, considered very ugly by Tresson standards, though."
