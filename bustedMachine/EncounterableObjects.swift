...
let Trash: Item = Item(name: "TRASH", description: "This is some trash. Let's see -- an issue of Mad magazine, an old foot, pizza crusts, vinyl SKINS, an unopened cardboard BOX, tissues, newspapers, and a sock...", pocketable: true, replenishable: true, contents: [Skins.name: Skins, ScoobySnacks.name: ScoobySnacks], simpleUse: "You sniff the trash. Smells like home.")
