...
let Gate: Item = Item(name: "GATE", description: "This is a chainlink fence gate. It is not especially secure. There's no lock or anything.", pocketable: false, simpleUse: "You open and close the gate. Though, frankly, it's kind of pointless, since you can just hop over it and walk right through.")
...
let Napkins: Item = Item(name: "NAPKINS", description: "These are torn napkins. You suspect that somebody was ripping them up to smoke out of them.", pocketable: false)
