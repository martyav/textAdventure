...
let ShotgunShack: Building = Building(name: "SHACK", description: "This is a shotgun shack. The rooms in this building come one after another, back to front. Someone appears to have remodeled it to add extra rooms, though. This sort of home design predates central air and indoor plumbing, so it's rare to see it aboard space stations.", allowedIn: true)
