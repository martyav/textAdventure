...
let Clover: Item = Item(name: "CLOVER", description: "This is clover. You can tell because all these little plants have four lea -- Wait, aren't four-leaf clovers supposed to be rare?", pocketable: true, replenishable: true, simpleUse: "You rub the clover for good luck. Like all the other clover plants up here, it's a four-leaf clover.")
...
let Trees: Item = Item(name: "TREES", description: "These are definitely trees. They're tall, they have branches, and they're covered in black bark. The one thing they're missing is leaves.", pocketable: false)
let Fibers: Item = Item(name: "FIBERS", description: "These are fibers. If you were a botanist, you would identify them as fungal in nature. You find their pale, moist appearance creepy.", pocketable: false)
...
let Trash: Item = Item(name: "TRASH", description: "This is some trash. Let's see -- an issue of Mad magazine, an old foot, pizza crusts, vinyl SKINS, an unopened cardboard BOX, wet tissues, and a sock...", pocketable: true, replenishable: true, contents: [Skins.name: Skins, ScoobySnacks.name: ScoobySnacks], simpleUse: "You sniff the trash. Smells like home.")
let Bags: Item = Item(name: "BAGS", description: "These are dirty plastic bags. They are wet and brittle. Hasn't anyone up here heard of recycling?", pocketable: true, replenishable: true, contents: [:], simpleUse: "You open up the bag. It's full of holes and quite useless for holding anything.")
...
let Gate: Item = Item(name: "GATE", description: "This is a chainlink fence gate. There's no lock on it. In fact, you could probably climb over it.", pocketable: false, simpleUse: "You fiddle with the gate. Though, frankly, it's kind of pointless, since you can just hop over it and walk right through.")
...
let Table: Item = Item(name: "TABLE", description: "This is a table. It looks like somebody dragged it off of a street corner somewhere. Someone has left their PIPE on top of it.", pocketable: false, contents: [Pipe.name: Pipe], simpleUse: "You try to stand on the table. You're short so it's kind of a gymnastic maneuver to get on top.")
let Sofa: Item = Item(name: "SOFA", description: "This is a sofa made out of a synthetic material called Naugahyde. Folks used to joke that Naugahyde was made out of the hide of a fictional animal called a Nauga. Nowadays, such a joke would be in bad taste. Not only are many folks fictional animals, most of them have skin made out of synthetic materials.", pocketable: false, simpleUse: "You sit on the Naugahyde sofa. It's kind of like sitting on a giant friend.")
...
let Napkins: Item = Item(name: "NAPKINS", description: "These are torn napkins. You suspect that somebody was ripping them up to smoke out of them. There is a BAGGY underneath.", pocketable: true, replenishable: true, contents: [Baggy.name: Baggy], simpleUse: "You wipe your fuzzy hands on the napkins.")
